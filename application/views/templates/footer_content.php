    <!-- Footer Start -->
    <div class="container-fluid bg-dark pt-5 px-lg-5 mt-5 px-4">
        ...
        <div class="row py-4">
            <div class="col-lg-4 col-md-6 mb-5">
                ...
                <h6 class="mt-4 mb-4 text-white text-uppercase font-weight-bold">Follow Us</h6>
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                ...
                <div class="mb-3">
                    ...
                    <?php if ($brt->kategori == "alat musik") { ?>
                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2 w-25" href="<?=base_url('kategori/alat_musik')?>"><?= $brt->kategori ?> <img src="<?= base_url() ?>assets/img/alat_musik.png" style="height: 23px;" class="ml-2" alt=""></a>
                        <?php }; ?>

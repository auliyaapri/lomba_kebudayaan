                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      ...
                      <a href="post-details.html"><h4><?php echo $brg->judul_konten;  ?></h4></a>
                      <ul class="post-info">
                      ...
                      <ul>
                        <li>
                          <div class="author-thumb">
                            <img src="<?=base_url()?>assets_blog/images/comment-author-01.jpg" alt="">
                          </div>
                        ...
                        <li class="replied">
                          <div class="author-thumb">
                            <img src="<?=base_url()?>assets_blog/images/comment-author-02.jpg" alt="">
                          </div>
                          <div class="right-content">
                        ...
                        <li>
                          <div class="author-thumb">
                            <img src="<?=base_url()?>assets_blog/images/comment-author-03.jpg" alt="">
                          </div>
                          <div class="right-content">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="sidebar-item recent-posts">
                    ...
                    <?php $this->load->view('recent_post/recent_post'); ?>
                    ...
                    <!-- <div class="content">
                      <ul>
                        ...
                        <li><a href="post-details.html">
                          <h5></h5>
                          <a class="h2 m-0 text-warning text-uppercase font-weight-bold" href="<?= base_url('detail/detail_konten/' . $brg->id_konten);?>"><?= $brg->judul_konten ?></a>

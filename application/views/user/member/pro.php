    ...
    <div class="container mt-5">
        ...
        <form action="<?= base_url() . 'user/Tambah_membership'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" value="user dapat mengupload unlimited." name="keterangan" placeholder="user dapat mengupload lebih dari 10 konten. " readonly>
            </div>
            <div class="form-group">

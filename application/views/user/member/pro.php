    ...
    <h1 class="text-center">Paket Membership  <span class="font-weight-bolder"><?php echo ucfirst($nama_paket) ?></span></h1>
        <form action="<?= base_url() . 'user/Tambah_membership'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" value="Pada paket ini pengguna bisa menambahkan artikel dalam batas waktu hanya berlaku 2 minggu saja. " name="keterangan" placeholder="user dapat mengupload lebih dari 10 konten. " readonly>
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Harga</label>
                <input class="form-control" type="text" value="Rp. 20.000" name="harga" placeholder="Rp. 20.000 " readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php $tgl_membership = date("F-d-Y", strtotime('+14 days')) ; ?>

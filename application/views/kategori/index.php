             ...
             <div class="row gx-1">
                 <?php foreach ($makanan as $ftr) : ?>
                     ...
                     <?php
                        ...
                        ?>
                     <div class="col-lg-3 col-md-5 ml-3 mt-4">
                         <div class="card-img">
                             <img src="<?= base_url() . '/upload_image/' . $daerah . '/' . strtolower($kategori_folder) . '/' . $ftr->gambar ?>" class="img-fluid card-img-top2">
                         </div>
                         <!-- <img src="<?= base_url() . '/upload_image/' . $daerah . '/' . strtolower($kategori_folder) . '/' . $ftr->gambar ?>" class="" style="object-fit: cover;"> -->
                         <div class="overlay">
                             <div class="mb-2">
                                 ...
                                 <?php }; ?>
                                 <?php $originalDate = $ftr->tgl_konten;

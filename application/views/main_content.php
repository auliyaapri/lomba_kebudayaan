         ...
         <div class="col-lg-7 px-0">
             <div class="owl-carousel main-carousel position-relative">
                 ...
                 <?php foreach ($home as $hm) {  ?>
                     ...
                     <?php if ($hm->kategori2 == "slider home") :    ?>
                             ...
                             <div class="overlay">
                                 <div class="mb-2">
                                     <h5 class="d-flex">
                                         ...
                                         <a class="text-white" href=""><small><?= $hm->tgl_konten ?></small></a>
                                     </h5>
                                 </div>
                             ...
                             <div class="overlay">
                                 <div class="mb-2">
                                    <?php if ($hm->kategori == "Tarian"){ ?>
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="<?= base_url('detail/detail_konten/' . $hm->id_konten); ?>"><?= $hm->kategori ?><img src="<?= base_url() ?>assets/img/dance_icon.png" style="height: 23px;" class="ml-2" alt=""></a>
                                    <?php } ; ?>
                                    <?php if ($hm->kategori == "Makanan"){ ?>
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2" href="<?= base_url('detail/detail_konten/' . $hm->id_konten); ?>"><?= $hm->kategori ?><img src="<?= base_url() ?>assets/img/food-icon.png" style="height: 23px;" class="ml-2" alt=""></a>
                                    <?php } ; ?>
